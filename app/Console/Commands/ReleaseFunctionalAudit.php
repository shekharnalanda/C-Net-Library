...
class ReleaseFunctionalAudit extends Command
{
    ...
    public function handle():int
    {
        $modules=[
            ...
            'Admissions Workflow'=>['admin.admissions.index','admin.admissions.show','admin.admissions.review','admin.admissions.approve'],
            'Enquiries CRM'=>['admin.enquiries.index','admin.enquiries.update','admin.enquiries.convert'],
            ...
            'Physical Library Circulation'=>['admin.library.index','admin.library.issue','admin.library.reservations.store','admin.library.reservations.cancel','admin.library.return','admin.library.lost','admin.library.charges.store','admin.library.recover'],
            'Physical Library Inventory'=>['admin.library-inventory.index','admin.library-inventory.categories.store','admin.library-inventory.categories.update','admin.library-inventory.categories.destroy','admin.library-inventory.books.store','admin.library-inventory.books.update','admin.library-inventory.books.destroy','admin.library-inventory.copies.store','admin.library-inventory.copies.bulk','admin.library-inventory.copies.update','admin.library-inventory.copies.destroy'],
            'Digital Library Safe CRUD'=>['admin.digital-resources.index','admin.digital-resources.store','admin.digital-resources.update','admin.digital-resources.destroy'],
