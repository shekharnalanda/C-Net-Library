...
<div class="wrap">
    <div class="top">
        <div><h1 style="margin:0">Cashbook & Expenses</h1><div class="muted">Append-only operating expense ledger.</div></div>
    ...
    <div class="grid">
        <div class="card">
            ...
            <form method="POST" action="{{ route('admin.expenses.store') }}">
                ...
                <div class="field"><label>Category<input name="category" value="{{ old('category') }}" placeholder="Rent, Electricity, Salary, Internet..." required></label></div>
