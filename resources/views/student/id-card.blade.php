    ...
    <div class="id">
        ...
        <div class="body">
            ...
            <div class="qrbox">
                ...
                <div class="muted" style="font-size:13px;margin-top:8px">Stable token generated. A QR renderer/scanner endpoint can encode this token without changing student identity.</div>
            </div>
        </div>
        <div class="foot">This ID is valid only with an active C-Net Library membership. Do not share the verification token publicly.</div>
    </div>
</div>
</body>
</html>
