...
<head>
    ...
    <style>
        body{font-family:Arial,sans-serif;background:#f5f7fb;margin:0;color:#1f2937}.wrap{max-width:1100px;margin:30px auto;padding:0 18px}.hero{background:#111827;color:#fff;border-radius:18px;padding:28px;margin-bottom:18px}.filters,.card{background:#fff;border:1px solid #e5e7eb;border-radius:14px;padding:16px;margin-bottom:14px}.grid{display:grid;grid-template-columns:repeat(4,1fr);gap:10px}.jobs{display:grid;grid-template-columns:1fr 1fr;gap:14px}.job{background:#fff;border:1px solid #e5e7eb;border-radius:14px;padding:18px}.muted{color:#6b7280}.tag{display:inline-block;background:#eef2ff;padding:5px 8px;border-radius:999px;font-size:12px;margin-right:6px}.btn{display:inline-block;background:#111827;color:#fff;text-decoration:none;padding:10px 13px;border-radius:9px;border:0;cursor:pointer}input,select{width:100%;box-sizing:border-box;padding:10px;border:1px solid #d1d5db;border-radius:9px}@media(max-width:800px){.grid,.jobs{grid-template-columns:1fr}}
    </style>
</head>
<body>
<div class="wrap">
    <div class="hero">
        ...
        <p style="margin-bottom:0">Verified summaries with direct links to official recruitment or application pages.</p>
    </div>
